...
namespace KTLT.DAL
{
    public class LT_HOADON_BAN : Common
    {

        static string filepath = @"C:\\VB2\\KTLT1\\21880103\\KTLT\\Data\\hdban_hang.txt";
        ...
        public static List<HOADON> ReadHOADON(string keyWord)
        {
            ...
            while (!file.EndOfStream)
            {
                ...
                if (string.IsNullOrEmpty(keyWord) || prod.CodeId.ToLower() == keyWord.ToLower() || prod.Name.ToLower().Contains(keyWord.ToLower()))
                {
                    lst.Add(prod);
                }
            }
